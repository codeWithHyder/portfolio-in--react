...
const Navbar = () => {
  return (
    <div className='flex flex-wrap justify-between p-2 bg-slate-100 rounded-sm w-screen h-auto px-3  items-center z-50 position sticky top-0 opacity-90 items-center'>
