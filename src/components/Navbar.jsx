...
const Navbar = () => {
  return (
    <div className='flex flex-wrap justify-between p-4 rounded-sm w-screen bg-gradient-to-r from-zinc-700  to-zinc-900 h-auto px-3  items-center z-50 position sticky top-0 opacity-90 items-center'>
